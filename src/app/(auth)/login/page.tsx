  ...
  return (
    <div className="glass border border-yellow-500/15 rounded-3xl p-8 sm:p-10 animate__animated animate__fadeIn">
      ...
      <div className="text-center mb-8">
        ...
        <h1 className="font-display text-3xl font-bold text-yellow-100 mb-2">Welcome Back</h1>
        <p className="text-yellow-100/50 text-sm">Sign in to your SunCart account</p>
      </div>
      ...
      <div className="flex items-center gap-3 mb-5">
        ...
        <span className="text-yellow-100/30 text-xs">or sign in with email</span>
        <div className="flex-1 h-px bg-yellow-500/15" />
      </div>
